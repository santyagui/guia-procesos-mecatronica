...
const categories: Array<{
  ...
  },
  {
    ...
    guides: [
      ...
      { title: 'Cambio de grupo', meta: 'En línea · Primer mes', description: 'Solicita el cambio según horarios y cupos disponibles.', href: 'https://drive.google.com/file/d/1TRwXofCi5U2MDybacBE_d-rl15Gp6e7p/view', icon: Users },
      { title: 'Itinerario para nivel de grado', meta: '7.º y 8.º nivel', description: 'Activa el itinerario requerido para las asignaturas ofertadas.', href: 'https://drive.google.com/file/d/1hev2apTepzpjPh6VsRsJH8toYZp2tj66/view', icon: Map },
    ],
  },
  {
