...
const categories: Array<{
...
}> = [
  {
    ...
    guides: [
      { title: 'Matrícula extraordinaria', meta: 'Presencial · Matrículas', description: 'Para estudiantes que necesitan matricularse una vez finalizado el período ordinario.', href: 'https://drive.google.com/file/d/1Cr_ctDx_zdCE7nTf597nIxfVXi5BvQOc/view', icon: CalendarPlus },
      { title: 'Matrícula especial', meta: 'Presencial · 15 días', description: 'Solicita autorización después del cierre de las matrículas extraordinarias.', href: 'https://drive.google.com/file/d/15hZEilkth8QClAh0O868BckRY-DrUaxb/view', icon: CalendarCheck },
      { title: 'Matrícula como condicionado oyente', meta: 'Tercera matrícula', description: 'Trámite obligatorio cuando cursarás una asignatura por tercera ocasión.', href: 'https://drive.google.com/file/d/1v90vMjmfC3u6sRo1aPnDeX1SIYxQ5o8s/view', icon: Ear },
      { title: 'Matrícula con aprobación previa de condicionado oyente', meta: 'Condicionado oyente', description: 'Registra asignaturas de condicionado oyente aprobadas en un período anterior.', href: 'https://drive.google.com/file/d/1Mebq4lyY6gs_NPoXspvNDPZji9ud1YAb/view', icon: BadgeCheck },
      { title: 'Matrícula después de eliminar la prefactura', meta: 'Falta de pago · Presencial', description: 'Solicita una nueva matrícula cuando la prefactura inicial fue eliminada.', href: 'https://drive.google.com/file/d/1MYgb_b_7IOWNd7RVJt0SsRHaWOArI_3e/view', icon: Receipt },
      { title: 'Reingreso a la carrera', meta: 'En línea · Primer mes', description: 'Orientación para retomar la carrera dentro del plazo institucional.', href: 'https://drive.google.com/file/d/1w2ba4ceO19zhgpkBbpnYdEvfsTg_T6bu/view', icon: RotateCcw },
    ],
  },
  {
    ...
    guides: [
      { title: 'Extensión de horas', meta: 'Antes de matricularse', description: 'Solicita autorización para superar la carga académica regular.', href: 'https://drive.google.com/file/d/1Agvr4MLo4xIFIPi-CeJh2k-ciHu_flhH/view', icon: Clock },
      { title: 'Incremento de asignaturas', meta: 'En línea · Primer mes', description: 'Agrega asignaturas después de haber realizado tu matrícula.', href: 'https://drive.google.com/file/d/1LvD_gQZY3IDGTNWUJB1XO8KX_s5qwDAc/view', icon: ListPlus },
      { title: 'Incremento de asignaturas por eliminación de prefactura', meta: 'En línea · Consejo de Carrera', description: 'Solicita el incremento cuando la prefactura de las asignaturas agregadas fue eliminada por falta de pago.', href: 'https://drive.google.com/file/d/15tSho5FkAHWYyULItXvbq3pWf-qqbZ1q/view', icon: ListPlus },
      { title: 'Retiro de asignaturas', meta: 'En línea', description: 'Gestiona el retiro y consulta las condiciones de transferencia de valores.', href: 'https://drive.google.com/file/d/1A8wzZTZJHj0cyiT0uHjPHvqyEsHN2abj/view', icon: ListMinus },
      { title: 'Cambio de grupo', meta: 'En línea · Primer mes', description: 'Solicita el cambio según horarios y cupos disponibles.', href: 'https://drive.google.com/file/d/154e8lWyZI9cizDsCe645Fco1tKmA0CQf/view', icon: Users },
      { title: 'Itinerario para nivel de grado', meta: '7.º y 8.º nivel', description: 'Activa el itinerario requerido para las asignaturas ofertadas.', href: 'https://drive.google.com/file/d/1NYfjUkqDRt739NjVg9lpOEbH4lZeRrdA/view', icon: Map },
    ],
  },
  {
    ...
    guides: [
      { title: 'Matrícula en nivel superior sin suficiencia de lengua extranjera', meta: 'Desde 5.º nivel', description: 'Gestiona tu matrícula si todavía no cuentas con suficiencia B1.', href: 'https://drive.google.com/file/d/1vcjczOkHvn2-Rrq59OLPDJ8pYCwdGJ2V/view', icon: BookOpenCheck },
      { title: 'Eliminación de prematrícula de inglés', meta: 'Primer mes', description: 'Solicita eliminar la prematrícula y revisa las condiciones aplicables.', href: 'https://drive.google.com/file/d/1kI21_agBvp-1y9N5--SOzDy3dNdVD2C6/view', icon: Trash2 },
    ],
  },
  {
    ...
    guides: [
      { title: 'Prácticas de Servicio Comunitario I', meta: '5.º nivel · En línea', description: 'Consulta el proceso según el calendario de matrículas.', href: 'https://drive.google.com/file/d/1prtj-GDz1APkIgVNOkgpFxv7XNrZPY6g/view', icon: HandHeart },
      { title: 'Prácticas de Servicio Comunitario II', meta: '6.º nivel · En línea', description: 'Consulta el proceso según el calendario de matrículas.', href: 'https://drive.google.com/file/d/1prtj-GDz1APkIgVNOkgpFxv7XNrZPY6g/view', icon: Handshake },
      { title: 'Prácticas Preprofesionales', meta: '7.º nivel · En línea', description: 'Consulta el proceso según el calendario de matrículas.', href: 'https://drive.google.com/file/d/1prtj-GDz1APkIgVNOkgpFxv7XNrZPY6g/view', icon: Factory },
    ],
  },
  {
    ...
    guides: [
      { title: 'Formas de pago UPS', meta: 'En línea y presencial', description: 'Revisa los canales habilitados en la Sede Quito.', href: 'https://drive.google.com/file/d/1mc1sv90tzt65DfHwEdBh-RO7fnRVRysp/view', icon: WalletCards },
      { title: 'Eliminación de prefactura', meta: 'Sin pagos realizados', description: 'Solicita eliminar una prefactura con datos o método de pago incorrectos.', href: 'https://drive.google.com/file/d/16Kbvkcx6BHsvs2Gde70R0kwF8vUdLpuE/view', icon: FileX },
    ],
  },
  {
    ...
    guides: [
      { title: 'Formulario de Registro de Asignaturas', meta: 'Documento editable', description: 'Registra datos personales, facturación y asignaturas.', href: 'https://drive.google.com/file/d/11x1lkhFFQ-iQfcf8HJoI6rFz1CtIGXgZ/view', icon: FilePenLine, resource: true },
